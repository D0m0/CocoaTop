...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	cell.textLabel.text = [presetNames objectAtIndex:indexPath.row];
	NSString *colNames = @"Command";
	for (NSNumber *idx in [presetList objectForKey:[presetNames objectAtIndex:indexPath.row]]) {
		int i = [idx intValue];
		if (i) colNames = [colNames stringByAppendingFormat:@", %@", ((PSColumn *)[[PSColumn psGetAllColumns] objectAtIndex:i]).name];
	}
...
{
	[[NSUserDefaults standardUserDefaults] setObject:[presetList objectForKey:[presetNames objectAtIndex:indexPath.row]] forKey:@"Columns"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)src
{
	...
	cell.textLabel.text = ((PSColumn *)[ar[src.section] objectAtIndex:src.row]).descr;
	return cell;
}
