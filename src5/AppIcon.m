	...
	@try {
		for (NSString *Key in @[@"CFBundleIcons~ipad", @"CFBundleIcons", @"CFBundleIconFiles", @"CFBundleIconFile"]) {
			...
			if ([Value isKindOfClass:[NSString class]]) {
				...
				if ([Value isEqualToString:@"icon"] && [[app objectForKey:@"CFBundleIdentifier"] isEqualToString:@"com.apple.mobilecal"])
					return @"icon-about";
				return Value;
			}
		}
