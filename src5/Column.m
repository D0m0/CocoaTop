...
+ (NSArray *)psGetAllColumns
{
	...
	dispatch_once(&onceToken, ^{
		allColumns = [@[
		[PSColumn psColumnWithName:@"Command line" descr:@"Command line" align:UITextAlignmentLeft width:170 refresh:NO
		...
		[PSColumn psColumnWithName:@"PID" descr:@"Process ID" align:UITextAlignmentRight width:50 refresh:NO
		...
		[PSColumn psColumnWithName:@"PPID" descr:@"Parent PID" align:UITextAlignmentRight width:50 refresh:NO
		...
		[PSColumn psColumnWithName:@"%" descr:@"%CPU Usage" align:UITextAlignmentRight width:50 refresh:YES
		...
		[PSColumn psColumnWithName:@"Time" descr:@"Process Time" align:UITextAlignmentRight width:75 refresh:YES
		...
		[PSColumn psColumnWithName:@"S" descr:@"Mach Task State" align:UITextAlignmentLeft width:30 refresh:YES
		...
		[PSColumn psColumnWithName:@"Flags" descr:@"Raw Process Flags (Hex)" align:UITextAlignmentLeft width:70 refresh:YES
		...
		[PSColumn psColumnWithName:@"RMem" descr:@"Resident Memory Usage" align:UITextAlignmentRight width:70 refresh:YES
			data:^NSString*(PSProc *proc) { return !proc->basic.resident_size ? @"-" :
				[NSString stringWithFormat:@"%.1f MB", (float)proc->basic.resident_size / 1024 / 1024]; }
			sort:^NSComparisonResult(PSProc *a, PSProc *b) { return b->basic.resident_size - a->basic.resident_size; }
			summary:^NSString*(PSProcArray* procs) { return [NSString stringWithFormat:@"%.1f MB", (float)procs.memUsed / 1024 / 1024]; }],
		[PSColumn psColumnWithName:@"VSize" descr:@"Virtual Address Space Usage" align:UITextAlignmentRight width:70 refresh:YES
			data:^NSString*(PSProc *proc) { return !proc->basic.virtual_size ? @"-" :
				[NSString stringWithFormat:@"%.1f MB", (float)proc->basic.virtual_size / 1024 / 1024]; }
			sort:^NSComparisonResult(PSProc *a, PSProc *b) { return b->basic.virtual_size - a->basic.virtual_size; }
			summary:^NSString*(PSProcArray* procs) { return [NSString stringWithFormat:@"%.1f MB", (float)procs.memTotal / 1024 / 1024]; }],
		[PSColumn psColumnWithName:@"User" descr:@"User Id" align:UITextAlignmentLeft width:80 refresh:NO
		...
		[PSColumn psColumnWithName:@"Group" descr:@"Group Id" align:UITextAlignmentLeft width:80 refresh:NO
		...
		[PSColumn psColumnWithName:@"TTY" descr:@"Terminal" align:UITextAlignmentLeft width:65 refresh:NO
		...
		[PSColumn psColumnWithName:@"Thr" descr:@"Thread Count" align:UITextAlignmentRight width:40 refresh:YES
		...
		[PSColumn psColumnWithName:@"Ports" descr:@"Mach Ports" align:UITextAlignmentRight width:50 refresh:YES
		...
		[PSColumn psColumnWithName:@"Mach" descr:@"Mach System Calls" align:UITextAlignmentRight width:52 refresh:YES
		...
		[PSColumn psColumnWithName:@"BSD" descr:@"BSD System Calls" align:UITextAlignmentRight width:52 refresh:YES
		...
		[PSColumn psColumnWithName:@"CSw" descr:@"Context Switches" align:UITextAlignmentRight width:52 refresh:YES
		...
		[PSColumn psColumnWithName:@"Prio" descr:@"Mach Actual Threads Priority" align:UITextAlignmentLeft width:42 refresh:YES
		...
		[PSColumn psColumnWithName:@"BPri" descr:@"Base Process Priority" align:UITextAlignmentLeft width:42 refresh:NO
		...
		[PSColumn psColumnWithName:@"Nice" descr:@"Process Nice Value" align:UITextAlignmentRight width:42 refresh:YES
		...
		[PSColumn psColumnWithName:@"Role" descr:@"Mach Task Role" align:UITextAlignmentLeft width:75 refresh:YES
		...
		[PSColumn psColumnWithName:@"MSent" descr:@"Mach Messages Sent" align:UITextAlignmentRight width:70 refresh:YES
		...
		[PSColumn psColumnWithName:@"MRecv" descr:@"Mach Messages Received" align:UITextAlignmentRight width:70 refresh:YES
...
+ (NSMutableArray *)psGetShownColumnsWithWidth:(NSUInteger *)width
{
	...
	for (NSNumber* order in columnOrder)
		if (order.unsignedIntegerValue < cols.count) {
			PSColumn *col = [cols objectAtIndex:order.unsignedIntegerValue];
			if (*width < col.width) break;
			col.tag = tag++;
			[shownCols addObject:col];
			*width -= col.width;
		}
	*width += ((PSColumn *)[shownCols objectAtIndex:0]).width;
	return shownCols;
}
...
+ (NSArray *)psGetOpenFilesColumns
{
	...
	dispatch_once(&onceToken, ^{
		ofColumns = [@[
		[PSColumn psColumnWithName:@"Open file/socket" descr:@"" align:UITextAlignmentLeft width:220 refresh:NO
		...
		[PSColumn psColumnWithName:@"FD" descr:@"" align:UITextAlignmentRight width:50 refresh:NO
		...
		[PSColumn psColumnWithName:@"Type" descr:@"" align:UITextAlignmentLeft width:50 refresh:NO
...
+ (NSArray *)psGetOpenFilesColumnsWithWidth:(NSUInteger *)width
{
	...
	*width += ((PSColumn *)[cols objectAtIndex:0]).width;
	return cols;
}

- (instancetype)initWithName:(NSString *)name descr:(NSString *)descr align:(UITextAlignment)align width:(NSInteger)width
...
+ (instancetype)psColumnWithName:(NSString *)name descr:(NSString *)descr align:(UITextAlignment)align width:(NSInteger)width
	refresh:(BOOL)refresh data:(PSColumnData)data sort:(NSComparator)sort summary:(PSColumnData)summary
{
