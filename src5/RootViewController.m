...
- (void)viewDidLoad
{
	...
	if (isPhone) {
		NSDictionary *font = [NSDictionary dictionaryWithObject:[UIFont systemFontOfSize:25.0] forKey:UITextAttributeFont];
	...
	[[NSUserDefaults standardUserDefaults] registerDefaults:@{
		...
		@"SortColumn" : @1,
		@"SortDescending" : [NSNumber numberWithBool:NO],
		@"SockSortColumn" : @2,
		@"SockSortDescending" : [NSNumber numberWithBool:YES],
		@"UpdateInterval" : @"1",
		@"FullWidthCommandLine" : [NSNumber numberWithBool:NO],
		@"AutoJumpNewProcess" : [NSNumber numberWithBool:NO],
		@"UseAppleIconApi" : [NSNumber numberWithBool:NO],
		@"CpuGraph" : [NSNumber numberWithBool:NO],
		@"FirstColumnStyle" : @"Bundle Identifier",
		@"ShowHeader" : [NSNumber numberWithBool:YES],
		@"ShowFooter" : [NSNumber numberWithBool:YES],
		@"ShortenPaths" : [NSNumber numberWithBool:YES],
	}];
	self.configChange = @"";
	self.configId = 0;
	self.fullScreen = NO;
...
- (void)viewWillAppear:(BOOL)animated
{
	...
	self.sorter = [self.columns objectAtIndex:sortCol];
